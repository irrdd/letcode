 ...
 * @LastEditTime: 2022-08-16 17:03:12
 * @LastEditors: 王东旭
 * @Description: 
 * @FilePath: /letcode/test/程序员面试金典/13.分割链表.spec.ts
 *  
 */
import { partition, partition2, partition3, partition4 } from "../../src/程序员面试金典/13.分割链表";
...
describe('分割链表',()=>{
    ...
    test('头插法',()=>{
        const arr = getArray([1,4,3,2,5,2],3,partition4)
        expect(arr).toEqual([1,2,2,4,3,5])
        const arr2  = getArray([2,1],2,partition4)
        expect(arr2).toEqual([1,2])
    }) 
})